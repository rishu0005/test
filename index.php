...
<section class="hero-section ">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6  hero-section-text">
                <h3 class="active">Hello, I'm</h3>
                <h1>Edward Davis</h1>
            ...
            <!-- Hero Section Image and social Media Start  -->
            <div class="col-lg-6">
                <div class="hero-img-container">
                    <img src="./img/hero-img.jpg" class="img-fluid" alt="">
                </div>
                <div class="hero-section-social-media">
                    <a href="#" class="social-media-active"><i class="fa-solid fa-basketball"></i> <span class="social-media-name">Dribble</span> </a>
                    <a href="#"><i class="fa-brands fa-behance "></i> <span class="social-media-name">Behance</span></a>
                    <a href="#"><i class="fa-brands fa-twitter "></i> <span class="social-media-name">Twitter</span> </a>
                    <a href="#"><i class="fa-brands fa-linkedin "></i> <span class="social-media-name">LinkedIn</span> </a>
                </div>
            </div>
            <!-- Hero Section Image and social Media End -->
...
<!-- About Section Starts  -->
 ...
 <div class="container">
    <div class="row">
        <div class="col-lg-12">
            <div class="section-heading text-center">
                <h2 class="section-sub-heading">ABOUT ME</h2>
    ...
    <div class="row mt-5">
        ...
        <div class="col-lg-6 ">
                <h3 class="section-title">Hi There! I'm Edward Davis</h3>
                <h3 class="active margin-bottom-light section-title-h3">Visual Designer</h3>
                <p class="section-title-p margin-bottom-light">I am a Visual Designer with a strong focus on digital branding. Visul design seeks to attract, inspire, create desires and motivate people to respond to messages, with a view to making a favorable impact.</p>
                <ul class="list-unstyled margin-bottom-heavy">
                    <li class="about-li">
                     ...
                     <li class="about-li">
                        <span>Language</span> : <span>Engllish, Germanic</span>
                    </li>
                     <li class="about-li">
                ...
                <a href="#" class="hero-btn text-decoration-none text-dark margin-top-heavy">Download CV</a>
        </div>
    </div>
...
<section class="section-service">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading text-center">
                    <h2 class="section-sub-heading">SERVICES</h2>
                    <h3>SERVICES</h3>
                </div>
            </div>
        </div>
                ...
                <g>
                  ...
                  <path d="m432 112a24 24 0 1 0 -24-24 24.028 24.028 0 0 0 24 24zm0-32a8 8 0 1 1 -8 8 8.009 8.009 0 0 1 8-8z"></path>
                    ...
                    <div class="service-card-content">
                        <div class="service-card-title">Sketches</div>
                        <div class="service-card-description">Lorem ipsum dolor sittem ametamn elit, per sed do eiusmoad teimpor sittem elit inuning utsed sittem.</div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
              ...
              <div class="col-lg-4 col-md-6">
                <div class="service-card">
                    ...
                    <div class="service-card-content">
                        <div class="service-card-title">Product Design</div>
                        <div class="service-card-description">Lorem ipsum dolor sittem ametamn elit, per sed do eiusmoad teimpor sittem elit inuning utsed sittem.</div>
                    </div>
                </div>
            </div>
              ...
              <div class="col-lg-4 col-md-6">
                ...
                <g>
                  ...
                  <path d="M442.68,363.48,392,312.8V165.27l22.4-22.4a7.953,7.953,0,0,0,1.93-3.13L433.3,88.82A8,8,0,0,0,423.18,78.7L392,89.09V40A32.042,32.042,0,0,0,360,8H152a32.042,32.042,0,0,0-32,32V86.53L69.32,137.21a8,8,0,0,0,0,11.31L120,199.2V346.74L80.63,386.11A32.005,32.005,0,0,0,120,436.01V472a32.042,32.042,0,0,0,32,32H360a32.042,32.042,0,0,0,32-32V425.47l50.68-50.68A8,8,0,0,0,442.68,363.48ZM413.06,98.94l-4.99,14.97-9.98-9.98Zm-31.95,10.64,21.31,21.31-.67,2-4.32,4.32-22.64-22.64,4.32-4.32ZM306.92,227.72l-5.66-5.66,67.88-67.88a8,8,0,1,0-11.32-11.32l-67.88,67.88-5.66-5.65,79.2-79.2,22.63,22.64-7.74,7.74-.05.05ZM376,181.27V296.8l-57.76-57.76ZM293.44,24l-4.5,16H222.25l-4-16ZM136,40a16.021,16.021,0,0,1,16-16h49.75l6.49,25.94A8,8,0,0,0,216,56h79a8,8,0,0,0,7.7-5.83L310.06,24H360a16.021,16.021,0,0,1,16,16V94.42l-3.74,1.25a7.953,7.953,0,0,0-3.13,1.93l-96.16,96.17L148.52,69.32a8,8,0,0,0-11.31,0L136,70.53ZM114.59,420.05a16.005,16.005,0,1,1-22.64-22.63l11.31-11.32,22.64,22.64Zm-.01-45.26,5.66-5.65,22.62,22.62-5.65,5.66Zm90.51-90.5,22.63,22.63-73.54,73.54-22.63-22.64ZM136,330.74V215.2l57.77,57.77ZM376,472a16.021,16.021,0,0,1-16,16H152a16.021,16.021,0,0,1-16-16V421.26L239.04,318.24,363.48,442.68a8,8,0,0,0,11.31,0l1.21-1.21Zm-6.86-46.29-22.63-22.63,5.66-5.66a8,8,0,0,0-11.32-11.31l-5.65,5.65-11.32-11.31,16.97-16.97a8,8,0,0,0-11.31-11.31l-16.97,16.97-11.32-11.32,5.66-5.65a8,8,0,0,0-11.31-11.32l-5.66,5.66L278.63,335.2l16.97-16.97a8,8,0,0,0-11.32-11.32l-16.97,16.97L256,312.57l5.66-5.66a8,8,0,1,0-11.32-11.31l-5.65,5.65a.035.035,0,0,1-.02-.01l-11.3-11.3,16.97-16.97a8,8,0,0,0-11.31-11.31l-16.97,16.97-11.29-11.29c-.01-.01-.01-.02-.02-.03l5.65-5.65a8,8,0,1,0-11.31-11.32L199.43,256l-11.31-11.31,16.97-16.97a8,8,0,0,0-11.32-11.32L176.8,233.37l-11.31-11.31,5.66-5.66a8,8,0,0,0-11.32-11.31l-5.65,5.66-11.32-11.32,16.97-16.97a8,8,0,0,0-11.31-11.31l-16.97,16.97L120.24,176.8l5.65-5.65a8,8,0,0,0-11.31-11.32l-5.66,5.66L86.29,142.86l39.6-39.59L408.73,386.11Zm50.91-50.92L137.21,91.95l5.65-5.66L267.29,210.72c.01.01.01.02.02.03s.02.01.03.02l16.93,16.94c.01,0,.01,0,.01.01s.01,0,.01.01l16.95,16.94c.01.01.01.02.02.03s.02.01.03.02l77.02,77.02a.234.234,0,0,0,.07.07l47.33,47.33Z"></path>
                    ...
                    <div class="service-card-content">
                        <div class="service-card-title">App Design</div>
                        <div class="service-card-description">Lorem ipsum dolor sittem ametamn elit, per sed do eiusmoad teimpor sittem elit inuning utsed sittem.</div>
                    </div>
                </div>
            </div>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="service-card">
                    ...
                    <div class="service-card-content">
                        <div class="service-card-title">Motion Graphics</div>
                        <div class="service-card-description">Lorem ipsum dolor sittem ametamn elit, per sed do eiusmoad teimpor sittem elit inuning utsed sittem.</div>
                    </div>
                </div>
            </div>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="service-card">
                    ...
                    <div class="service-card-content">
                        <div class="service-card-title">Responsive Design</div>
                        <div class="service-card-description">Lorem ipsum dolor sittem ametamn elit, per sed do eiusmoad teimpor sittem elit inuning utsed sittem.</div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="portfolio-card-item">
                        <a href="./img/portfolio1_lg.jpg">
                            <div class="zoom-in-img">
                             ...
                             <div class="portfolio-card-item-hover text-center d-flex flex-column justify-content-center align-items-center">
                            <i class="fa-solid fa-circle-plus text-center"></i>
                            <div class="">      <h4 class="">Product Design</h4>
                            <p  class="p">Design / Marketing</p></div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="slider-card">
                                <div class="slider-content">
                                    <p class="p text-center">"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc ligula nulla, tincidunt id faucibus sed, suscipit feugiat turpis."</p>
                                    <div class="slider-quote">
                                        <img src="./img/quote.png" alt="">
                                    </div>
                                </div>
                                <div class="slider-author-content text-center">
                                    <img src="./img/client1.png"  alt="">
                                    <h3>Richard Miles</h3>
                                    <p class="p">Chairman </p>
                                </div>
                            </div>
                        </div>
...
<section class="blog-section">
    <div class="container">
         <div class="row">
            <div class="col-lg-12">
                <div class="section-heading text-center">
                    <h2 class="section-sub-heading" style="right: 25%;">LATEST NEWS</h2>
                    <h3>BLOG</h3>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-card">
                    <div class="blog-image overflow-hidden">
                        <img src="./img/blog3.jpg" class="img-fluid zoom-in" alt="">
                    </div>
                    <div class="blog-info">
                        <p class="p">By: <span class="active"> Admin</span> <span class="blog-divider">|</span>
                        <span class="active">27-09-2020</span></p>
                    <h3 class="blog-title">Were there any mistakes you've made as a designer</h3>
                    </div>
                </div>
            </div>
             ...
             <div class="col-lg-4 col-md-6">
                <div class="blog-card">
                    <div class="blog-image overflow-hidden">
                        <img src="./img/blog1.jpg" class="img-fluid zoom-in" alt="">
                    </div>
                    <div class="blog-info">
                        <p class="p">By: <span class="active"> Admin</span> <span class="blog-divider">|</span>
                        <span class="active">27-09-2020</span></p>
                    <h3 class="blog-title">What are the latest trends in Graphic design accroding to you</h3>
                    </div>
                </div>
            </div>
             ...
             <div class="col-lg-4 col-md-6">
                <div class="blog-card">
                    <div class="blog-image overflow-hidden">
                        <img src="./img/blog2.jpg" class="img-fluid zoom-in" alt="">
                    </div>
                    <div class="blog-info">
                        <p class="p">By: <span class="active"> Admin</span> <span class="blog-divider">|</span>
                        <span class="active">27-09-2020</span></p>
                    <h3 class="blog-title">What do you think makes someone a good designer </h3>
                    </div>
                </div>
            </div>
        </div>
...
<section class="contact-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading text-center">
                    <h2 class="section-sub-heading" style="right: 25%;">CONTACT ME</h2>
                    <h3>CONTACT ME</h3>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-5">
            <div class="col-lg-6 pe-3">
                ...
                <form action="">
                    <input type="text" name="" class=" form-input form-control " placeholder="Your Name" id="">
                    <input type="email" name="" class=" form-input form-control " placeholder="Your Email" id="">
                    <input type="text" name="" class=" form-input form-control" placeholder="Your Subject" id="">
                    <textarea name="" id="" rows="5" class="form-input form-control bg-nav" placeholder="Your Message"></textarea>
            ...
            <div class="col-lg-6 mt-sm-5">
                ...
                <p class="p mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc ligula nulla tincidunt id faucibus sed suscipit feugiat.</p>

                <div class="contact-info-wrap">
                    <div class="contact-info-card d-flex ">
                            <i class="fa-solid fa-envelope"></i>
                        <div class="contact-info-text d-flex flex-column">
                            <h3>Email</h3>
                            <a href="mailto: devis@example.com" class="text-decoration-none p">devis@example.com</a>
                            <a href="mailto: info@support.com" class="text-decoration-none p">info@support.com</a>
                        </div>
                    </div>
                      ...
                      <div class="contact-info-card d-flex ">
                        ...
                        <div class="contact-info-text d-flex flex-column">
                            <h3>Phone</h3>
                            <a href="mailto: devis@example.com" class="text-decoration-none p">+1 876-369-9009</a>
                            <a href="mailto: info@support.com" class="text-decoration-none p">+1 213-519-1786</a>
                        </div>
                    </div>
                     ...
                     <div class="contact-info-card d-flex ">
                        ...
                        <div class="contact-info-text d-flex flex-column">
                            <h3>Address</h3>
                            <p class="p">2661 High Meadow Lane Bear Creek, <br> Olancha, KY 93544</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="social-profile">
                    ...
                    <div class="social-media-links-container ">
                        ...
                        <a href="#" class="social-media-active text-decoration-none"><i class="fa-solid fa-basketball"></i> <span class="social-media-name">Dribble</span> </a>
                        <a href="#" class="text-decoration-none"><i class="fa-brands fa-behance "></i> <span class="social-media-name">Behance</span></a>
                        <a href="#" class="text-decoration-none"><i class="fa-brands fa-twitter "></i> <span class="social-media-name">Twitter</span> </a>
                        <a href="#" class="text-decoration-none"><i class="fa-brands fa-linkedin "></i> <span class="social-media-name">LinkedIn</span> </a>
                    </div>
                     <!-- <div class="hero-section-social-media"> -->
                    <!-- </div> -->
