            ...
            <nav class="navbar navbar-expand-lg">
              ...
              <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                 ...
                 <div class="nav-contact">
                   ...
                   <p class="font-nav-contact nav-contact active d-flex justify-content-center mb-0 align-items-center">  <i class="fa-solid fa-phone text-light ps-3 pe-3 me-3 "></i>  +1 971 234 1508</p> 
                 </div>
             </div>
            </nav>
        </div>
